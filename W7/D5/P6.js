...
const app = express();
const secretKey = "Ashu@123";
const userToken = jwt.sign({userId:101,role:"user",email:"e@e.com"},
    secretKey,
    {expiresIn:"1h"}
);

const managerToken = jwt.sign({userId:102,role:"manager",email:"m@e.com"},
    secretKey,
    {expiresIn:"1h"}
);
const adminToken = jwt.sign({userId:103,role:"admin",email:"a@e.com"},
    secretKey,
    {expiresIn:"1h"}
);
